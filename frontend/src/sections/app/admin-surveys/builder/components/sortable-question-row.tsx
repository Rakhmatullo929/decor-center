  ...
  return (
    <>
      ...
      >
        <Stack direction="row" spacing={1.5} alignItems="flex-start">
          ...
          <Tooltip title={tx('common.actions.delete')}>
            <IconButton size="small" color="error" onClick={deleteConfirm.onTrue}>
      ...
      <ConfirmDialog
        ...
        title={tx('surveys.builder.dialogs.deleteQuestion.title')}
        content={tx('surveys.builder.dialogs.deleteQuestion.content')}
